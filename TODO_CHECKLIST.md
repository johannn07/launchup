...
| **Admin role removed — capabilities moved to Manager, logins split, tiers seeded** | `feat/remove-admin-role` (3 commits) — local, unpushed, live-verified against Neon. Closes a spec deviation: SRS §2.3 defines three user classes, SDD §1.4 puts every administrative function behind Manager |
