  ...
  <nav class="flex h-16 w-4/5 items-center p-[var(--navbar-padding,0.5rem)] px-0">
    ...
    <div class="flex-none font-medium">
      <ul class="flex flex-1 cursor-pointer items-center gap-7 text-[15px]">
        <li class="hover:text-flutter-blue active:scale-95"><a href="#hero">Home</a></li>
        <li class="hover:text-flutter-blue active:scale-95"><a href="#howitwork">How it Works</a></li>
        <li class="hover:text-flutter-blue active:scale-95"><a href="#aboutus">About Us</a></li>
        <li class="hover:text-flutter-blue active:scale-95"><a data-sveltekit-reload href="/login">Login</a></li>
        <li>
          <Button
            onclick={toggleMode}
            variant="ghost"
