  ...
  >
    ...
    >
      ...
      <div
        ...
        class="illustration-card relative z-10 w-full max-w-[34rem] rounded-[2rem] border border-white/60 bg-white/75 p-6 backdrop-blur dark:border-white/10 dark:bg-slate-950/55"
        style="
...
<style>
  ...
  .hero-entered .hero-item:nth-child(5) { opacity: 1; transform: none; transition-delay: 0.45s; }
