// Order is the specification's: the SRS §1.2 scope and SDD §2.2 both list the
// dimensions TRL, MRL, RRL, ARL, ORL. Everything that displays dimensions in sequence
